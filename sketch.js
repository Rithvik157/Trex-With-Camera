...
function spawnclouds(){
 if(frameCount%60===0){ 
   var cloud = createSprite(Trex.position.x + 350,25,15,15);
...
function spwanobsticles(){
  if (frameCount%90===0){
    var obsticle = createSprite(Trex.position.x + 350,125,14,14);
...
function spwanflyingdino(){
 if(frameCount%150===0){
   var flyingdino = createSprite(Trex.position.x + 350,40,15,15);
